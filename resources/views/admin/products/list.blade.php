                            ...
                            <tbody>
                              @forelse($allcolors as $key=>$item)
                                <tr>
                                    ...
                                    <?php } ?>                                    <td><a href='{{route('admin.product.edit',$item->id)}}' class="btn btn-info btn-sm"><i
                                                class="fas fa-edit"></i></a>&nbsp;<a onclick="return confirm('Are you sure?')" href="{{route('admin.product.deleted',$item->id)}}"
